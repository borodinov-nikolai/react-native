...
export type GetProductsQuery = { __typename?: 'Query', products: { __typename?: 'ProductsResponse', data: Array<{ __typename?: 'Product', id: number, number: number, name: string, price: number, features?: Array<string> | null, exclusive?: string | null, stock: number, series?: { __typename?: 'Series', id: number, originalName: string } | null, catalogPreview?: { __typename?: 'Image', id: number, name: string, url: string } | null }>, meta?: { __typename?: 'Meta', pagination?: { __typename?: 'MetaPagination', page: number, pageSize: number, total: number } | null } | null } };
